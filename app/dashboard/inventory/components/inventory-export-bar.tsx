      ...
      <div className="mt-3 flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center">
        ...
        <div className="flex flex-1 flex-wrap gap-2">
            ...
            {pdfOpen && (
              <div className="absolute bottom-full left-0 z-30 mb-1 min-w-[200px] overflow-hidden rounded-xl border border-white/10 bg-[#0D0D1A] py-1 shadow-xl sm:bottom-auto sm:top-full sm:mb-0 sm:mt-1">
                <button
                  ...
                  onClick={() => guard(() => runInventoryPdfRingkas(products, ctx))}
                >
                ...
                <button
                  type="button"
                  className="block w-full px-4 py-2.5 text-left text-xs text-[#F2F1F8] hover:bg-white/5"
                  onClick={() => guard(() => runInventoryPdfDetail(products, ctx))}
                >
          ...
          <button
            type="button"
            className={BTN}
            onClick={() => guard(() => runInventoryExcel(products, ctx))}
          >
        ...
        >
          ...
          >
            ...
            <button
              ...
              onClick={() => guard(() => runInventoryThermal(products, ctx, resolveThermalMm()))}
            >
