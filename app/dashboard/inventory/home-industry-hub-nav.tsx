...
const LINKS = [
  { href: "/dashboard/inventory", label: "Stok & Jual", icon: Package, match: "/inventory" },
  { href: "/dashboard/produksi", label: "Produksi", icon: Factory, match: "/produksi" },
];

export default function HomeIndustryHubNav() {
