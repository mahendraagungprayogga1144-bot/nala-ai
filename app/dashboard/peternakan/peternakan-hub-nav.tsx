...
const LINKS = [
  { href: "/dashboard/inventory", label: "Stok Ternak", icon: Package, match: "/inventory" },
  { href: "/dashboard/peternakan", label: "Manajemen Batch", icon: Bird, match: "/peternakan" },
];

export default function PeternakanHubNav() {
